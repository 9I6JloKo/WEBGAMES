        ...
        <form action="addingClient" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Name"  value="${clientName}">
                </div>
                <div class="form-group">
                    <label for="clientSurname" class="form-label mt-4">Client surname</label>
                    <input type="text" class="form-control" id="clientSurname" name="clientSurname" placeholder="Surname"  value="${clientSurname}">
                </div>
                <div class="form-group">
                    <label for="clientNumber" class="form-label mt-4">Client number</label>
                    <input type="number" class="form-control" id="clientNumber" name="clientNumber"  placeholder="e.g : (53993935)" min="5000000" step="1" value="${clientNumber}">
                </div>
                <div class="form-group">
                    <label for="clientMoney" class="form-label mt-4">Client money(euros)</label>
                    <input type="number" class="form-control" id="clientMoney" name="clientMoney" placeholder="Money" min="0" step="0.01"  value="${clientMoney}">
                </div>
                <div class="form-group">
                    <label for="clientLogin" class="form-label mt-4">Client login</label>
                    <input type="text" class="form-control" id="clientLogin" name="clientLogin" placeholder="Login"  value="${clientLogin}">
                </div>
                <div class="form-group">
                    <label for="clientPassword" class="form-label mt-4">Client password</label>
                    <input type="text" class="form-control" id="clientPassword" name="clientPassword" placeholder="Password"  value="${clientPassword}" minlengt="6">
                </div>
